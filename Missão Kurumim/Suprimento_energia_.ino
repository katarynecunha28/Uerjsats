...
void loop() {
  ...
  if (comandoRecebido) {
    enviarDadosParaMaster("Dados do Suprimento de Energia: " + String(busVoltage) + "V " + String(current_mA) + "mA " + String(tempbateria1) + "C " + String(tempbateria2) + "C " + String(tempbateria3) + "C", 4); // Envia dados para o Master
